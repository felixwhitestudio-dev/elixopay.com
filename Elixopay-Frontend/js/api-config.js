// Elixopay API Configuration Helper
...
(function () {
    ...
    window.API_CONFIG = {
        ...
        ENDPOINTS: {
            ...
            stripeConnect: {
                status: '/api/v1/stripe-connect/status',
                onboard: '/api/v1/stripe-connect/onboard'
            },
            webhooks: {
                list: '/api/v1/webhooks',
                create: '/api/v1/webhooks',
                delete: (id) => `/api/v1/webhooks/${id}`,
    ...
    console.log(`🔗 Elixopay API: ${window.API_CONFIG.BASE_URL} | Demo: ${window.API_CONFIG.IS_DEMO}`);
