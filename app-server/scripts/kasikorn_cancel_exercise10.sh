...
CANCEL_URL="https://openapi-sandbox.kasikornbank.com/v1/qrpayment/cancel"
...
echo "----------------------------------------"
echo "Step 2: Cancel QR (Status Voided)..."
echo "----------------------------------------"
...
# Prepare JSON Body
# changes: env-id (QR011), partnerTxnUid (PARTNERTEST0008), origPartnerTxnUid (PARTNERTEST0011)
BODY=$(cat <<EOF
{
  "partnerTxnUid": "PARTNERTEST0008",
...
curl --location --request POST "$CANCEL_URL" \
